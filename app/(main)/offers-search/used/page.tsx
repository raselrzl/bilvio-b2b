...
/* export function generateDummyOffers(count: number) {
  ...
  return Array.from({ length: count }).map((_, i) => {
    ...
    const productionYear = randomNumber(2010, 2025);
    ...
    return {
      ...
      vat: randomNumber(0, 25),
      transportCost: randomNumber(4000, 12000),
      productionYear, // ✅ New field
    };
  });
} */
...
export default function OffersSearchUsedCarServer() {
  ...
  return (
    <div className="max-w-7xl mx-auto w-full">
      ...
      <div className="mt-6">
        <OffersUsedCarFilterForm initialOffers={products} />
      </div>
    </div>
  );
}
